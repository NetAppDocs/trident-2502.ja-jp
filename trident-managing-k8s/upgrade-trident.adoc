...
* 4つのリリース期間外のリリースからアップグレードする場合は、複数ステップのアップグレードを実行してください。アップグレード元のバージョンに対応するアップグレード手順に従って、4つのリリース期間内に収まる最新リリースにアップグレードしてください。例えば、23.01 を実行していて、25.02 にアップグレードしたい場合（：）
+
